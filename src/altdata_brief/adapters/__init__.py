...
1. **live**: the source project's HTTP endpoint (opt-in via
   ``ALTDATA_BRIEF_LIVE=1`` or ``--source-mode live``).
...
See :mod:`altdata_brief.config` for the preference toggling.
"""

from altdata_brief.adapters.base import (
    AdapterBase,
    AdapterError,
    AdapterPayload,
    AdapterUnavailable,
...
from altdata_brief.adapters.etf_512400 import ETF512400Adapter
from altdata_brief.adapters.index_research import IndexResearchAdapter
from altdata_brief.adapters.quant_trading import QuantTradingAdapter
from altdata_brief.adapters.super_pricing import SuperPricingAdapter
