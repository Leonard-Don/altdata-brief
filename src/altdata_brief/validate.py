...
Run via ``altdata-brief validate``. The intent is to short-circuit
...
from altdata_brief.config import public_summary_path
...
def run_all_checks(
    ...
    *,
    ...
    resolved from :func:`altdata_brief.config.public_summary_path`.
    """
